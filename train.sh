        ...
        do
            ...
            do
                ...
                python train.py \
                    ...
                    --train_data_path "['./data/$dataset/train_noCoT_1000.json']"   \
                    --val_data_path "['./data/$dataset/valid_noCoT_1000.json']" \
                    --output_dir ./model/${dataset}/BERT_noCoT_vlnoCoT_ep25_${lr} \
                    --batch_size 250  \
                    --micro_batch_size 4 \
                    --num_epochs 25 \
                    --learning_rate $lr \
